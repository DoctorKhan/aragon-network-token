# BEE Presale allocations

| Name     |                   Address                 |  USD  |  Ether  |     BEE    | Ether TX | BEE TX | Agreement SHA256                                                 |
|----------|:------------------------------------------:|:-------:| :-------:|:----------:|:----:|:----:|------------------------------------------------------------------|
...
All presale contributions were denominated in USD but payed in ETH. Ether amounts vary for different presale entities because all agreements weren't signed at the same time. The amount of BEE calculated is how many BEE could have been bought with the USD amount in the preallocation day.

BEE amount will be calculated on allocation day using the following formula:

`BEE = 120 * USD_contribution / ETH_price`
